    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::ENDL)
                   || (token::DO <= tok && tok <= token::UMINUS)
                   || tok == 59
                   || (40 <= tok && tok <= 41));
#endif
      }
